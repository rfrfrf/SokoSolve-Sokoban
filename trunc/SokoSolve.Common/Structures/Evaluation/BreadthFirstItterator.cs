...
{
    /// <summary>
    /// High-speed, optimised, breadth-first (shallowest node first) Eval Strategy iterator
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class BreadthFirstItterator<T> : BaseItterator<T>
    {
        ...
        public override INode<T> GetNext(out EvalStatus Status)
        {
            ...
            INode<T> next = evaluationList.GetBest();
